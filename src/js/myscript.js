...
class Game {
  constructor( svg ) {
    ...
    this.ballIsSticky = true;



  }
  createRacket(){
    this.racket =    S.rect(125,785,150,10,'#000');

   $(document).on('keydown', function( e ) {
  //   console.log(e.keyCode); sulla console ti dice il numero del tasto
      switch (e.keyCode) {
  ...
  moveRacketPixel(x){
    ...
    if ( racketX+x > 0 && racketX+x < 400-this.racketWidth){
      this.racket.attr('x',racketX+x);
